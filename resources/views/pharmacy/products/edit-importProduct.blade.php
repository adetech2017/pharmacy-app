...
<div class="mb-3">
    <h1 class="align-middle h3 d-inline">Edit Import Product</h1>
</div>
<div class="row">
    <div class="col-12 col-lg-10">
        <div class="card">
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('product.update.import') }}" enctype="multipart/form-data">
                    @csrf
                    {{-- @method('PUT') --}}
                    ...
                    <div class="row">
                        ...
                        <div class="mt-3 text-center">
                            <button type="submit" class="btn btn-lg btn-primary">Published Product</button>
                        </div>
                    </div>
                </form>
            </div>
