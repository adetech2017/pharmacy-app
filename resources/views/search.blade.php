                        ...
                        <div class="pb-1 col-lg-4 col-md-6 col-sm-6">
                            <div class="mb-4 product-item bg-light">
                                <div class="overflow-hidden product-img position-relative">
                                    <img class="w-100" src="{{ asset('products')}}/{{ $product->image }}" alt="{{$product->product_name}}" height="301px" width="301px">
                                ...
                                <div class="py-4 text-center">
                                    <a class="h6 text-decoration-none text-truncate" href="{{ url('product-details')}}/{{ $product->slug }}">{{$product->product_name}}</a>
